...
print ('Доступные функции: "транспонирование", "умножение", "определение ранга"')
print () 
fun = input('Выберите функцию: ') 
while fun not in ('транспонирование', 'умножение', 'определение ранга'): 
    fun = input('Данной функции не существует, введите корректную функцию: ') 
print () 
 
if fun in ('транспонирование','определение ранга'): 
