n=int(input("Введите кол-во строк матрицы (от 1 до 3):"))
a=[]
for i in range(n):
...
print(" ")
b = input("Выбирете функцию:")
print(" ")
while b.lower() not in ("транспонирование","умножение","определение ранга"):
    print("Введена некорректная функция")
if b.lower() == "определение ранга":
    if n != len(a[0]):
        print("Функция не доступна")
    else:
        if n==2:
        ...
        if n==3:
            if a[0][0]*a[1][1]*a[2][2]+a[1][0]*a[2][1]*a[0][2]+a[0][1]*a[1][2]*a[2][0]-(a[0][2]*a[1][1]*a[2][0]+a[1][2]*a[2][1]*a[0][0]+a[1][0]*a[2][2]) !=0:
...
if b.lower() == "умножение":
    ...
    if n2 == len(a[0]):
        ...
        if n2 == 3:
         ...
         print("Умножение матриц не возможно")
